      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
                ...
                <div class="box-header with-border">
                    <center><h3 class="box-title"><b>Fichas Existentes</b></h3></center>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table class="table table-bordered">
                      <th><center>Nome Colaborador</center></th>
                      <th><center>Data Admiss&atilde;o</center></th>
                      <th><center>Data do Ultimo Evento</center></th>
                      <?php 
                      ...
                      echo "<tr><td><center><a href='visualiza_ficha.php?id=".$rowa['id_Ficha']."'>".$row['Nome']."</center></td><td><center>".$data[2]."/".$data[1]."/".$data[0]."</a></center></td><td><center>".$rowa['Periodo']."</center></td></tr>";
