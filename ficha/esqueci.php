...
$sql = "SELECT * FROM tbl_usuario WHERE Login='".$_POST['login']."' AND Nome='".$_POST['nome']."'";
$result = mysqli_query($conn,$sql);
    ...
    while($row = mysqli_fetch_assoc($result))
    {
        ...
        {
       echo "<script>alert('Usuário não registrado favor comunicar o RH.');</script>";
  ...
  <body class="hold-transition register-page">
    <div class="register-box">
      ...
      <div class="register-box-body">
        ...
        <form action="lembrar.php" method="POST">
          <div class="form-group has-feedback">
            <input type="password" name='senha' class="form-control" placeholder="Informe a nova senha">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
            <div class="form-group has-feedback">
            <input type="password" name="rsenha" class="form-control" placeholder="Repita a nova senha">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="row">
            <div class="col-xs-8">
